...
class CommentDisplayName with _$CommentDisplayName {
  ...
  const factory CommentDisplayName.integration({
    required String resolvedName,
  }) = IntegrationDisplayName;

  const factory CommentDisplayName.user({
    required String resolvedName,
  }) = UserDisplayName;

  const factory CommentDisplayName.custom({
    required String resolvedName,
  }) = CustomDisplayName;
  ...
  factory CommentDisplayName.fromJson(Map<String, dynamic> json) {
    ...
    switch (type) {
      case 'integration':
        return CommentDisplayName.integration(
          resolvedName: resolved ?? '',
        );
      case 'user':
        return CommentDisplayName.user(
          resolvedName: resolved ?? '',
        );
      case 'custom':
        return CommentDisplayName.custom(
          resolvedName: resolved ?? '',
        );
      default:
