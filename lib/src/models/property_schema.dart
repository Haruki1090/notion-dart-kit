...
class PropertySchema with _$PropertySchema {
  ...
  Map<String, dynamic> toJson() => when(
    ...
    title: (id, name) => {'id': id, 'name': name, 'type': 'title', 'title': {}},
    ...
    date: (id, name) => {'id': id, 'name': name, 'type': 'date', 'date': {}},
    people: (id, name) => {
      'id': id,
      'name': name,
      'type': 'people',
    ...
    files: (id, name) => {'id': id, 'name': name, 'type': 'files', 'files': {}},
    email: (id, name) => {'id': id, 'name': name, 'type': 'email', 'email': {}},
    phoneNumber: (id, name) => {
      'id': id,
      'name': name,
      'type': 'phone_number',
